...
export default function AimTrainer({ onExit, lang, setLang, isMobile, name, setName, best, setBest, onSession, onRoundStart, showToast }) {
  ...
  return (
    ...
    >
      ...
      <aside
        className={`no-scrollbar absolute left-0 top-0 z-20 flex h-full w-80 flex-col gap-4 overflow-y-auto border-r border-white/10 bg-[#141d24]/60 backdrop-blur-xl p-6 transition-transform duration-300 ease-out ${
